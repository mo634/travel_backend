import MostImportant100Word from '../models/mostImportant100Word.model.js'; // Adjust the path as necessary
...
const uploadPdf = async (req, res) => {
    try {
        ...
        const pdf = new MostImportant100Word({
...
const updatePdf = async (req, res) => {
    try {
        ...
        const pdf = await MostImportant100Word.findById(req.params.id);
        if (!pdf) {
...
const deletePdf = async (req, res) => {
    try {
        ...
        await MostImportant100Word.findByIdAndDelete(req.params.id);
...
const getPdf = async (req, res) => {
    try {
        const pdfs = await MostImportant100Word.find();
