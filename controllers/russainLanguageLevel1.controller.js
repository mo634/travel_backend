...
const uploadPdf = async (req, res) => {
    try {
        ...
        const pdf = new RussainLanguageLevel1({
...
const updatePdf = async (req, res) => {
    try {
        ...
        const pdf = await RussainLanguageLevel1.findById(req.params.id);
        if (!pdf) {
...
const deletePdf = async (req, res) => {
    try {
        ...
        await RussainLanguageLevel1.findByIdAndDelete(req.params.id);
...
const getPdf = async (req, res) => {
    try {
        const pdfs = await RussainLanguageLevel1.find();
