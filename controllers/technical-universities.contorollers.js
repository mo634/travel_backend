import TechnicalUniversity from '../models/technical-universities.models.js'; // Adjust the path as necessary
...
const uploadPdf = async (req, res) => {
    try {
        ...
        const pdf = new TechnicalUniversity({
...
const updatePdf = async (req, res) => {
    try {
        ...
        const pdf = await TechnicalUniversity.findById(req.params.id);
        if (!pdf) {
...
const deletePdf = async (req, res) => {
    try {
        ...
        await TechnicalUniversity.findByIdAndDelete(req.params.id);
...
const getPdf = async (req, res) => {
    try {
        const pdfs = await TechnicalUniversity.find();
