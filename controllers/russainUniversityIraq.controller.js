import RussainUniversityIraq from '../models/russainUniversityIraq.model.js'; // Adjust the path as necessary
...
const uploadPdf = async (req, res) => {
    try {
        ...
        const pdf = new RussainUniversityIraq({
...
const updatePdf = async (req, res) => {
    try {
        ...
        const pdf = await RussainUniversityIraq.findById(req.params.id);
        if (!pdf) {
...
const deletePdf = async (req, res) => {
    try {
        ...
        await RussainUniversityIraq.findByIdAndDelete(req.params.id);
...
const getPdf = async (req, res) => {
    try {
        const pdfs = await RussainUniversityIraq.find();
